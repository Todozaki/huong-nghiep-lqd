            ...
            {step === 'method' && (
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-500">Chọn phương thức bạn muốn sử dụng</p>
                </div>
                ...
                <div className="space-y-3">
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full flex items-center justify-center gap-3 p-4 bg-white border-2 border-slate-200 text-slate-700 rounded-2xl hover:bg-slate-50 transition-all font-bold disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full flex items-center justify-center gap-3 p-4 bg-slate-900 text-white rounded-2xl hover:bg-slate-800 transition-all font-bold disabled:opacity-50"
                  >
                      ...
                      {result.topCareers.map((career, i) => (
                        ...
                        >
                          ...
                          <div className="p-8">
                            ...
                            <h3 className="text-2xl font-bold text-slate-800 mb-3 group-hover:text-indigo-600 transition-colors">{career.name}</h3>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                                <div className="flex items-center gap-1.5 text-slate-400 mb-1">
                                  ...
                                  <span className="text-[10px] font-bold uppercase tracking-wider">Lương khởi điểm</span>
                                </div>
                                <div className="text-xs font-bold text-slate-700">{career.startingSalary}</div>
                              </div>
                              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                                <div className="flex items-center gap-1.5 text-slate-400 mb-1">
                          ...
                          <div key={i} className="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-[10px]">
                              <div className="p-2 bg-slate-50 rounded-xl">
                                <span className="text-slate-400 block mb-0.5 uppercase font-bold">Lương khởi điểm</span>
                                <span className="text-slate-800 font-bold">{career.startingSalary}</span>
                              </div>
                              <div className="p-2 bg-slate-50 rounded-xl">
